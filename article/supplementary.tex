...
\sessionpy{pytex_subfigs(
        ...
        caption='
                \\textbf{The uncorrected population-level response to block stimulation does not significantly differ from the wild type control corrected results in \cref{fig:mbfc,fig:mofc}.}
