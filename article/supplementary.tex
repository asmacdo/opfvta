...
\sessionpy{pytex_subfigs(
        [
                {'script':'scripts/map_block_filteredManual.py', 'label':'subjects', 'conf':'article/1col_map.conf', 'options_pre':'{.48\\textwidth}',
                        'caption':'Block stimulation of rostralmost implant category group, slices centered on VTA. \\vspace{1.2em}'
                        },
                {'script':'scripts/map_block_filtered_autoManual.py', 'label':'subjects', 'conf':'article/1col_map.conf', 'options_pre':'{.48\\textwidth}',
                        'caption':'Block stimulation of rostralmost implant category group, slices centered on langest cluster. \\vspace{1.2em}'
                        },
                {'script':'scripts/map_block_otherManual.py', 'label':'subjects', 'conf':'article/1col_map.conf', 'options_pre':'{.48\\textwidth}',
                        'caption':'Block stimulation of caudalmost implant category group, slices centered on VTA.'
                        },
                {'script':'scripts/map_block_other_autoManual.py', 'label':'subjects', 'conf':'article/1col_map.conf', 'options_pre':'{.48\\textwidth}',
