...
\sessionpy{pytex_subfigs(
        ...
        caption='
                \\textbf{Neither omnibus (block and phasic stimulus based) nor PA-coordinate classification show a better projection segmentation than block trial-based classification.}
...
\sessionpy{pytex_subfigs(
        ...
        caption='
                \\textbf{The uncorrected population-level response to block stimulation does not significantly differ from the wild type control corrected results in \cref{fig:mbfc,fig:mboc}.}
