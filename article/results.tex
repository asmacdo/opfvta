...
\sessionpy{pytex_subfigs(
        [
                {'script':'scripts/map_block_filtered.py', 'label':'subjects', 'conf':'article/2x3_map.conf', 'options_pre':'{.48\\textwidth}',
                        'caption':'Block stimulation, slices centered on VTA. \\vspace{1.1em},'
                        'label':'sumb',
                        },
                {'script':'scripts/map_block_filtered_auto.py', 'label':'subjects', 'conf':'article/2x3_map.conf', 'options_pre':'{.48\\textwidth}',
