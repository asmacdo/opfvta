...
(\sessionpy{boilerplate.anova(expression='C(Q("Depth rel. skull [mm]")) + C(Q("PA rel. Bregma [mm]")) + Task',factor='Task')}),
the depth
(\sessionpy{boilerplate.anova(expression='C(Q("Depth rel. skull [mm]")) + C(Q("PA rel. Bregma [mm]")) + Task',factor='C(Q("Depth rel. skull [mm]"))')})
bot not the PA coordinates
(\sessionpy{boilerplate.anova(expression='C(Q("Depth rel. skull [mm]")) + C(Q("PA rel. Bregma [mm]")) + Task',factor='C(Q("PA rel. Bregma [mm]"))')}).
...
>>>>>>> 98f36b1911cc85b90ea14d52956d463b5e1e534b
...
\sessionpy{pytex_subfigs(
        [
                {'script':'scripts/taskgroup.py', 'label':'subjects', 'conf':'article/3xq.conf', 'options_pre':'{.48\\textwidth}',
                        'caption':'Task group comparison for animals targeted at all explored combinations of implant coordinates. \\vspace{1em}'
                        },
                {'script':'scripts/implant_coordinates.py', 'label':'subjects', 'conf':'article/3x1.conf', 'options_pre':'{.48\\textwidth}',
...
\py{pytex_subfigs(
        [
                ...
                {'script':'scripts/map_phasic_filtered.py', 'label':'subjects', 'conf':'article/1col_map_2x3.conf', 'options_pre':'{.48\\textwidth}',
			'caption':'Phasic stimulation, slices centered on VTA. \\vspace{1.1em}'
                        },
                {'script':'scripts/map_phasic_filtered_auto.py', 'label':'subjects', 'conf':'article/1col_map_2x3.conf', 'options_pre':'{.48\\textwidth}',
