...
and the interaction of the depth and PA target coordinate (\sessionpy{boilerplate.anova(factor='C(Q("Depth rel. skull [mm]")):C(Q("PA rel. Bregma [mm]"))')}).
...
We classify the implant coordinates into a “best” and “rejected” group, via k-means clustering the aggregate VTA t-statistic scores into two clusters.
