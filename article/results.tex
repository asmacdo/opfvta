...
\sessionpy{pytex_subfigs(
        [
                {'script':'scripts/map_features_filtered.py', 'label':'subjects', 'conf':'article/2asymetric_map.conf',
                        'options_pre':'{.41\\textwidth}',
                        'options_pre_caption':'\\vspace{1.55em}',
                        'caption':'Comparison t-statistic showing Slices centered on largest cluster, statistical map thresholded at . \\vspace{.8em}',
                        'label':'filtered_map',
                        },
                {'script':'scripts/distributions_features_filtered.py', 'label':'subjects', 'conf':'article/2asymetric_distributions.conf',
                        'options_pre':'{.585\\textwidth}',
                        'caption':'Slices centered on largest cluster. \\vspace{.8em}',
                        'label':'filtered_mapa',
                        },
                {'script':'scripts/features_filtered_coronal.py', 'label':'tasks', 'conf':'article/coronal.conf', 'options_pre':'{.99\\textwidth}',
                        'caption':'Distribution densities of t-statistic values in the 10 most strongly activated areas.',
                        'label':'filtered_dist',
        ...
        caption='
                \\textbf{Activity measured by the opto-fMRI assay overlaps with the VTA projection map.}
                ',
        label='fig:filtered',
        options_pre='\\centering',
        )}
