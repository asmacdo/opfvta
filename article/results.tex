...
\py{pytex_subfigs(
        [
                ...
                {'script':'scripts/map_phasic_other.py', 'label':'subjects', 'conf':'article/1col_map_2x3.conf', 'options_pre':'{.48\\textwidth}',
			'caption':'Phasic stimulation, slices centered on VTA. \\vspace{1.1em}'
                        },
                {'script':'scripts/map_phasic_other_auto.py', 'label':'subjects', 'conf':'article/1col_map_2x3.conf', 'options_pre':'{.48\\textwidth}',
