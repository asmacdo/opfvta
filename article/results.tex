...
\sessionpy{pytex_subfigs(
        ...
        caption='
                \\textbf{Block stimulation elicits strong and clustered activity in the ventral striatum, in particular the nucleus accumbens.}
                Depicted are the results of the second-level analysis for block stimulus evoked activity, as observed in the best implant group animals and corrected for the wild type control response.
...
\begin{sansmath}
%%% I'd rather keep the main statement as a full sentence.
\sessionpy{pytex_subfigs(
        [
        ...
        caption='
                ...
                Depicted are results of the second-level analysis for block stimulus evoked activity, as observed in the best implant group animals and corrected for the wild type control response.
...
%%% I mention this, because looking at the graphic naïvely it would seem as phasic stimulation has no effect at all. It *almost* has no significant effect, but that only becomes obvious in the full model.
...
%%% Just saying the projections are weaker is not an additional statement.
...
%%% Voxel level is a more parsimonious specific term which I would like to keep consistent throughout the document.
...
%%% I would like to avoid putting the verb at the end.
...
%%% I would like to keep the section in the present tense.
...
%%% They're really more grains than patches.
