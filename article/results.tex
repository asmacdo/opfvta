...
(\py{boilerplate.anova(expression='Q("Depth rel. skull [mm]") + Q("PA rel. Bregma [mm]") + Task',factor='Task')}),
but not to the depth
(\py{boilerplate.anova(expression='Q("Depth rel. skull [mm]") + Q("PA rel. Bregma [mm]") + Task',factor='Q("Depth rel. skull [mm]")')})
or the PA coordinates
(\py{boilerplate.anova(expression='Q("Depth rel. skull [mm]") + Q("PA rel. Bregma [mm]") + Task',factor='Q("PA rel. Bregma [mm]")')}).
