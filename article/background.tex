...
%%% I really liked this :'(
%%% Maybe we should keep it for some bigger-picture context?
...
%%% “Degree centrality“ is a specific graph theory term
...
%%% I think my version is more concise.
...
%%% I think this appropriately addresses the distinction between localized interventions and whole-brain effects and measurement.
%%% Nowhere do I say that merely the efferent spectrum is the reason for study.
...
%%% Imaging is broader than mapping.
...
%%% I would like to keep the specific mention of macroscopic resolution being able to distinguish cell biological processes.
...
In this study aimed at whole-brain modelling of human VTA dopaminergic function in mice, three novel research outputs need to be produced.
%%% Could not read
...
%%% I like it better in the original, otherwise the subject is too far removed from the predicate.
