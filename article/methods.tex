...
\sessionpy{pytex_fig(
        ...
        caption='
                Volumetric plot of the right VTA region of interest used in the multivariate statistical modelling of and k-means target clustering based on VTA activation.
                \\vspace{-1em}
                ',
        label='vta',
...
The right VTA of the animals was injected with a solution containing recombinant Adeno-Associated Viruses (rAAVs).
